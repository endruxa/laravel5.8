...
<head>
    ...
    <title>{{ config('app.name', 'Moderna') }}</title>
                ...
                <div class="col-lg-8">
                    <article>
                        <div class="post-image">
                            ...
                            <img src={{url('img/dummies/blog/img1.jpg')}} alt="" />
                        </div>
                        <p>
                        ...
                        <div class="post-slider">
                            ...
                            <div id="post-slider" class="flexslider">
                                <ul class="slides">
                                    ...
                                    <li>
                                        <img src={{url('img/dummies/blog/img2.jpg')}} alt="" />
                                    </li>
                                    <li>
                                        <img src={{url('img/dummies/blog/img3.jpg')}} alt="" />
                                    </li>
                                </ul>
                            </div>
                            <!-- end flexslider -->
                    ...
                    <article>
                        <div class="post-video">
                            ...
                            <div class="video-container">
                                <iframe src={{url("http://player.vimeo.com/video/30585464?title=0&amp;byline=0")}}>
                                </iframe>
                            </div>
                        </div>
                        <p>
                ...
                <div class="col-lg-3">
                    <div class="widget">
                        ...
                        <div class="flickr_badge">
                            <script type="text/javascript" src={{url("http://www.flickr.com/badge_code_v2.gne?count=8&amp;display=random&amp;size=s&amp;layout=x&amp;source=user&amp;user=34178660@N03")}}></script>
                        </div>
                        <div class="clear">
                        </div>
                    </div>
